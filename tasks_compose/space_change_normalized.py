...
DATA_PATH = Path("/data/biophys/ashmat/data/myxo-project/space_change_normalized/")
...
print(f"Running for L {L} and N {N}")
...
solver = FourierSolver(n=N, L=L, model_params=model_params,
