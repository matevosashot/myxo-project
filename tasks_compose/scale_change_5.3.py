...
SCALES = np.logspace(np.log10(100.0), np.log10(0.01), 100+1)
np.random.default_rng(801).shuffle(SCALES)
print(SCALES)


DATA_PATH = Path("/data/biophys/ashmat/data/myxo-project/scale_change_5.31/")
...
solver = FourierSolver(n=751, L=50, model_params=model_params,
