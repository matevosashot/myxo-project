...
DATA_PATH = Path("/data/biophys/ashmat/data/myxo-project/scale_change_5/")
...
solver = FourierSolver(n=400, L=40, model_params=model_params,
                        dtype="float32", verbose=True, drop_phi=True, gcalc_Q_cls=GcalcForQ)
solver.precompute()

out = solver.save_results_h5(SCRATCH_PATH,save_C_P=True, save_C_Q=True,
                        save_P=True, save_P_diag=True,
                        save_Q=True, save_Q_diag=True,)
print(f"Saved {out}")
