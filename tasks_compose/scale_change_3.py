...
SCALES = np.logspace(np.log10(10.0), np.log10(0.01), 61)

DATA_PATH = Path("/data/biophys/ashmat/data/myxo-project/scale_change_3/")
...
solver = FourierSolver(n=600, L=50, model_params=model_params,
                        dtype="float32", verbose=True, drop_phi=True)
solver.precompute()
