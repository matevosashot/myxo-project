...
# set2_1 at BOX 40 -- HIGH-Nint half (Nint > 131).  Companion: _box40.sh.
#
# Identical to _box40.sh except for the grid list and --mem.  See that file's
# header for why solverParams={box->40} must accompany fbox->40, for the h-matched
# box20<->box40 pairs, and for the RSS measurements behind the lo/hi split.
#
# 1600G, not 600G: these are exactly the four grids that died at 600G in the
# box-20 run of THIS set (jobscripts/logs/56558539_14,15,16,17), all at the
# "[0] densify A,Q" line.  Extrapolating the measured 376 GB at Nint = 131 by n^2
# (n = 3 Nint^2) puts Nint = 161 near 860 GB.  1600G on 72 cpus is grantable: it
# is what set3_1/set3_2 use, and their four large tasks ran fine on it.
