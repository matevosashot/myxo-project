...
# set2_2_comove, lNoise = 0.5 -- HI tier.  Companions: the other four tiers of
# fluctuation-solver-set2_2_comove_lN05_{lo,mid,hi,h2,xl}.sh.
#
# Nint = 130, 131 -- n = 50700 / 51483, ~348-359 GiB and ~8 h per task.  600G is
# what the lNoise = 1.73 family already ran Nint = 131 at successfully.
# Covariance ~20 GiB each, ~200 GiB for this tier.
#
