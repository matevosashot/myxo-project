...
# set2_2_comove, lNoise = 0.5 -- XL tier.  Companions: the other four tiers of
# fluctuation-solver-set2_2_comove_lN05_{lo,mid,hi,h2,xl}.sh.
#
# Nint = 150, 151 -- n = 67500 / 68403, ~617-634 GiB and ~19 h per task.
#
# 2000G, not 1600G: 1600G is recorded in set2_2s _boxscan.sh as having been too
# tight for grids this size, and with only 10 tasks here there is no reason to
...
#
# THESE GRIDS CARRY THE ANSWER.  Both resolution criteria are met most widely
# here: the defect core ell_d = 0.8 reaches 6.1 h at box 10 and 4.1 h at box
# 15, and the cutoff lNoise = 0.5 reaches 3.8 h at box 10 -- but only 0.95 h at
# box 40, so at the largest box even this tier is at the edge for the noise
# length.  Covariance files are ~35 GiB each, ~350 GiB for this tier.
#
