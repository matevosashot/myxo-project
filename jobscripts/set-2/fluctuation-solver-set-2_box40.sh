...
# set-2 at BOX 40 -- LOW-Nint half (Nint <= 131).  Companion: _box40_hi.sh.
#
...
# "long" alone, whereas 267 nodes in "medium" have 72+.  Note the box-20 script
# asked for --ntasks=96, which is a request for 96 separate tasks, not 96 cores
# for one; --nodes=1 --ntasks=1 --cpus-per-task=72 is the correct spelling.
#
