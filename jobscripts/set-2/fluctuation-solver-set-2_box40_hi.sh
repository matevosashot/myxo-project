...
# set-2 at BOX 40 -- HIGH-Nint half (Nint > 131).  Companion: _box40.sh.
#
# Identical to _box40.sh except for the grid list and --mem.  See that file's
# header for why solverParams={box->40} must accompany fbox->40, for the RSS
# measurements behind the lo/hi split, and for the cpu-count change.
#
