...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 140   (n = 3 Nint^2 = 58800)
#
#  20 tasks = 2 B  x  5 box  x  2 steady-box variants.
#
#  Estimated ~5.6 h per task, ~173 GiB peak.  See
...
# The backend stages A, Q and C through this: 3 * 8n^2 = 77 GiB.
