...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 230   (n = 3 Nint^2 = 158700)
#
#  16 tasks = 2 B  x  4 box (>=10)  x  2 steady-box variants.
#
#  Estimated ~68 h per task, ~1501 GiB peak, ~563 GiB scratch,
#  ~188 GiB per covariance file.  Memory grows as Nint^4 and time as
