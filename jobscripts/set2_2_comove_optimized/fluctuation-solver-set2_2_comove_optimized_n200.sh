...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 200   (n = 3 Nint^2 = 120000)
#
#  16 tasks = 2 B  x  4 box (>=10)  x  2 steady-box variants.
#
#  Estimated ~30 h per task, ~858 GiB peak, ~322 GiB scratch,
#  ~107 GiB per covariance file.  Memory grows as Nint^4 and time as
#  Nint^6, so this is far more expensive than it looks next to Nint=150.  See
...
#
#  The array throttle (%2) is PER JOBSCRIPT.  Submitting several of these
...
# The backend stages A, Q and C through this: 3 * 8n^2 = 322 GiB.
