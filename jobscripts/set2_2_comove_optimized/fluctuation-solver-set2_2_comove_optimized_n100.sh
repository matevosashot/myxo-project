...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 100   (n = 3 Nint^2 = 30000)
#
#  20 tasks = 2 B  x  5 box  x  2 steady-box variants.
#
#  Estimated ~50 min per task, ~45 GiB peak.  See
...
#
#  The array throttle (%4) is PER JOBSCRIPT.  Submitting several of these
...
# The backend stages A, Q and C through this: 3 * 8n^2 = 20 GiB.
