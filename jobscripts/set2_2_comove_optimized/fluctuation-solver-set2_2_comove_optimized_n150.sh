...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 150   (n = 3 Nint^2 = 67500)
#
#  20 tasks = 2 B  x  5 box  x  2 steady-box variants.
#
#  Estimated ~8.4 h per task, ~227 GiB peak.  See
...
# The backend stages A, Q and C through this: 3 * 8n^2 = 102 GiB.
