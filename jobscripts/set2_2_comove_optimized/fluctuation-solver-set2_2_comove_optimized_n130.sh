...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 130   (n = 3 Nint^2 = 50700)
#
#  20 tasks = 2 B  x  5 box  x  2 steady-box variants.
#
#  Estimated ~3.7 h per task, ~128 GiB peak.  See
...
#
#  The array throttle (%3) is PER JOBSCRIPT.  Submitting several of these
...
# The backend stages A, Q and C through this: 3 * 8n^2 = 57 GiB.
