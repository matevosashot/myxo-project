...
# ===========================================================================
#  set2_2_comove_optimized -- Nint = 180   (n = 3 Nint^2 = 97200)
#
#  16 tasks = 2 B  x  4 box (>=10)  x  2 steady-box variants.
#
#  Estimated ~16 h per task, ~563 GiB peak, ~211 GiB scratch,
#  ~70 GiB per covariance file.  Memory grows as Nint^4 and time as
...
# The backend stages A, Q and C through this: 3 * 8n^2 = 211 GiB.
