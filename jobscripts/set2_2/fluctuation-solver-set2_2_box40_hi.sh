...
# set2_2 at BOX 40 -- HIGH-Nint half (Nint > 131).  Companion: _box40.sh.
#
# Identical to _box40.sh except for the grid list and --mem.  See that file's
# header for why solverParams={box->40} must accompany fbox->40, for the reduction
# from five lNoise values to three, for the l/h resolution table, and for the RSS
